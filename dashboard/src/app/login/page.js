    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-4">
      ...
      <Card className="w-full max-w-md bg-zinc-900/80 border-zinc-800 backdrop-blur relative z-10">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl font-bold text-white">Elastic Telemetry</CardTitle>
        ...
        <CardContent className="space-y-4">
          ...
          <a href="/api/auth/login" className="block">
            <Button className="w-full bg-[#5865F2] hover:bg-[#4752C4] text-white h-12 text-base">
